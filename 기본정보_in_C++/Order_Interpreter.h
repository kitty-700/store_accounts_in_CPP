...
private:
	bool init_person(std::string file_name, const  bool using_in_first_time); //생성자로부터 호출됨
	...
	void load(Order_token* site_name);
	...
	bool change_person(Person * person_to_change, const bool using_in_first_time);
public:
