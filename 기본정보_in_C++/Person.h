...
public:
	...
	Site * find_site_with_site_name(std::string site_name);
	Site * find_site_with_site_number(int site_number);
	int get_site_number_with_site_name(std::string site_name);
